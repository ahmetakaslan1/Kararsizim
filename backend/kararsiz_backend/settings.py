"""
Django settings for kararsiz_backend project.
"""
...
ROOT_URLCONF = 'kararsiz_backend.urls'
...
WSGI_APPLICATION = 'kararsiz_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PORT': os.environ.get('DB_POOLER_PORT', os.environ.get('DB_PORT', '5432')),
        'OPTIONS': {
            'sslmode': 'require',  # Supabase zorunlu kılar
        },
    }
}
